...
from BaseClasses.simulation_base import OptimalSimulation, ObservationThresholdContinuousSimulation
...
if __name__ == "__main__":
    ...
    episodes_per_simulation = 5  # Number of episodes per simulation run
    ...
    run_manager.run_simulations(simulation_list,False,4)