...
class AbstractAutonomy(ABC):
    ...
    @abstractmethod
    def _determine_action(self, *args, **kwargs):
        """Determine the best action based on the given conditions."""
...
class Autonomy(AbstractAutonomy):
    ...
    def __init__(self, dt, mdp_model: ValueFunction, use_expected_reward: bool = False, wind_threshold: float = 100.):
        super().__init__(dt, mdp_model, use_expected_reward, wind_threshold)
