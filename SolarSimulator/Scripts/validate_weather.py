...
def validate_dataframes_in_directory(directory):
        ...
        if file.endswith(".pkl"):
            ...
            try:
                ...
                if common_shape is None:
                    ...
                    raise ValueError(f"DataFrame in file {file} has a different size: {df.shape}. Expected: {common_shape}.")
    ...
    print(f"All DataFrames in directory '{directory}' are validated to have the same size: {common_shape}.")
    return dataframes
