...
def generate_alternating_wind_weather(start_time, end_time, freq='15min', high_wind_period=24, low_wind_period=24, high_wind_speed=40, low_wind_speed=5):
    """
...
expected_constant_wind_data.to_pickle(r'Data\TEST_CASES\Wind\expected_fake_weather_data_constant_wind.pkl')
