""" A script to plot the expected value table for the wind and solar simulations. """
...
table = pd.read_csv(
    r"Data\TEST_CASES\Wind\Meeting-Results\varyWind-varyWhale\ev_table.csv", header=None
).to_numpy()
...
plot_data(
    ...
    title="Flying vs Moored for Battery Capacity = 100%",
    legend="Flying",
)
plt.show()
